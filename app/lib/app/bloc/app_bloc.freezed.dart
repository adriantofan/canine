...
class _$StatusChangedImpl implements _StatusChanged {
  ...
  @override
  String toString() {
    return 'AppEvent._statusChanged(status: $status)';
  }
...
abstract class _StatusChanged implements AppEvent {
  const factory _StatusChanged(final AuthenticationStatus status) =
      _$StatusChangedImpl;
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl({this.status = AuthenticationStatus.unknown});
...
abstract class _AppState implements AppState {
  const factory _AppState({final AuthenticationStatus status}) = _$AppStateImpl;
