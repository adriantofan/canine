...
var _ = Describe("IntegrationRepository", Ordered, func() {
	...
	BeforeEach(func() {
		...
		var cachedInternalUserIDs []int64
		messagesRepo = postgres.NewMessageRepository(testDb, &cachedInternalUserIDs)
	})
